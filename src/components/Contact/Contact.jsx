    ...
    return(
        <Container style={{paddingTop: '50px'}} >
            ...
            <Col md={6} className="c-right">
                ...
                <span className='done'>{done && "Thanks for contacting me and be sure i have received your mail. If you are testing this functionality then i am confirming this thing working perfectly fine. If you have any serious query then i will reply. Also if you need me, you can conatct me on Linkedin."}</span>
                </form>
            </Col>
            </Row>
        </Container>
